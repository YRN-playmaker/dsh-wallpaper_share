				...
				try {
					...
					if (!out.ok) {
						...
						if (out.code === "share_passcode_required" || out.code === "share_passcode_wrong") {
							setLCodeErr(true);
							flashL(t.flashLFailed + "：" + (out.code === "share_passcode_required" ? t.launcherShareCode : t.launcherShareCodeWrong) + (out.error !== void 0 ? "（" + out.error + "）" : ""));
							return;
						}
						if (out.code === "share_auth_required") {
							...
							flashL(t.flashLFailed + "：" + t.launcherAuthNeed + (out.error !== void 0 ? "（" + out.error + "）" : ""));
							return;
						}
						if (out.code === "share_api_error" || out.code === "share_not_file") {
							flashL(t.flashLFailed + "：" + t.launcherShareFail + (out.error !== void 0 ? "（" + out.error + "）" : ""));
							return;
						}
						flashL(t.flashLFailed + (out.error !== void 0 ? "：" + out.error : ""));
						return;
					}
					...
					flashL(t.flashLFailed + "：" + String(e.message ?? e));
				} finally {
					setLBusy(false);
				}
			};
							...
							children: [
								...
								appsOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [" · ", t.launcherHelperHint] })]
									}),
