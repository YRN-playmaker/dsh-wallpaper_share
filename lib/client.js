window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		async function fetchCatalog(fetchFn = defaultFetch$1, url = "/we-sync/dwp/market/catalog") {
		...
		*/
		...
		function WallpaperSharePanel(props) {
			...
			const decayRef = (0, react.useRef)(null);
			const flipRef = (0, react.useRef)(() => {});
			const [pull, setPull] = (0, react.useState)(0);
			const [accRatio, setAccRatio] = (0, react.useState)(0);
			const [settling, setSettling] = (0, react.useState)(false);
			const [pageAnim, setPageAnim] = (0, react.useState)("");
			...
			const flipTo = (dir) => {
				...
				setAccRatio(0);
				setPull(0);
				setPageAnim(dir === 1 ? "out-next" : "out-prev");
				window.setTimeout(() => {
					setPage(dir === 1 ? "library" : "settings");
					setPageAnim(dir === 1 ? "in-next" : "in-prev");
					if (dir === 1) {
						loadApps();
						loadDwp();
						loadMarket();
			...
			(0, react.useEffect)(() => {
				...
				const onWheel = (e) => {
					...
					const dir = dy > 0 ? 1 : -1;
					if (!(pageRef.current === "settings" && dir === 1 || pageRef.current === "library" && dir === -1)) {
						accRef.current = 0;
						setAccRatio(0);
						setPull(Math.max(-16, Math.min(16, dy * .04)));
						armDecay();
						return;
					}
					accRef.current += dy;
					...
					setPull((pageRef.current === "settings" ? -1 : 1) * ratio * maxPull);
			...
			const loadDwp = async () => {
				try {
					...
					const [catalog, installed] = await Promise.all([fetchCatalog(f), fetchInstalled$1(f)]);
				...
				try {
					...
					if (!out.ok) {
						...
						if (out.code === "share_passcode_required" || out.code === "share_passcode_wrong") {
							setLCodeErr(true);
							flashLErr(t.flashLFailed + "：" + (out.code === "share_passcode_required" ? t.launcherShareCode : t.launcherShareCodeWrong) + (out.error !== void 0 ? "（" + out.error + "）" : ""));
							return;
						}
			...
			const onLauncherUninstall = async (rec) => {
				const r = await uninstallApp(rec.id, (u) => fetch(u));
				if (r.ok) {
					flashL(t.flashLUninstalled);
					loadLauncher();
					loadApps();
			...
			const subtitle = wallpaper === null ? t.applyHint : scene === null ? "" : renderMode === "eco" ? t.sceneEco : scene.live === true ? t.sceneExternal + " " + String(scene.status?.fps ?? "?") + "fps" : scene.model === true ? t.sceneModel : t.sceneFallback + scene.fallback;
			...
			const pageClass = (p) => {
				...
				} else cls.push("wesync-page-hidden");
				return cls.join(" ");
			};
			/** 拉扯位移只作用于当前页；翻页动画期间归零；弹回/拉扯时用 settle 过渡 */
			const pageStyle = (p) => {
				const y = page === p && pageAnim === "" ? pull : 0;
				const animating = page === p && pageAnim !== "";
				const settle = settling && pageAnim === "";
				return {
					transform: y !== 0 ? `translateY(${y.toFixed(1)}px)` : void 0,
					transition: animating || settle ? "transform 0.24s cubic-bezier(0.22, 1, 0.36, 1)" : void 0
				};
			};
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						className: pageClass("library"),
						style: pageStyle("library"),
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: "wesync-card",
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									libTab === "local" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: shownApps.map((app) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [app.hasPreview ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
														...
														children: app.source === "launcher" ? t.typeLauncherApp : t.typeWeApp
													})]
												}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													className: "wesync-app-title",
													style: {
												...
												return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [
														...
														/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
															...
															children: [c.state === "absent" || c.state === "update" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
															...
															}) : null, c.state === "installed" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
														href: "/we-sync/139-helper.user.js",
														target: "_blank",
														rel: "noreferrer",
														style: {
															color: "inherit",
														...
														children: [
															...
															/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
																...
																children: [
																	/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
																		className: "wesync-btn wesync-market-install",
																		onClick: () => onLaunch(rec.id, rec.title, rec.file, rec),
																		children: t.launcherLaunch
																	}),
																	/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
																		className: "wesync-btn",
																	...
																	/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
																		className: "wesync-btn wesync-market-uninstall",
																		onClick: () => {
																			onLauncherUninstall(rec);
																		},
																		children: t.launcherUninstall
																	})
																]
															}),
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						onClick: () => {
							if (page !== "settings") flipRef.current(-1);
						},
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "wesync-pager-label",
							children: t.pageSettings
						}), page === "settings" && accRatio < -.03 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "wesync-pager-progress",
							style: { transform: "scaleX(" + String(Math.min(1, -accRatio)) + ")" }
						}) : null]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						className: ["wesync-pager-dot", page === "library" ? "wesync-pager-dot-on" : ""].join(" "),
						title: t.pageLibrary,
						onClick: () => {
							if (page !== "library") flipRef.current(1);
						},
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "wesync-pager-label",
							children: t.pageLibrary
						}), page === "library" && accRatio > .03 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "wesync-pager-progress",
							style: { transform: "scaleX(" + String(Math.min(1, accRatio)) + ")" }
						}) : null]
					})]
